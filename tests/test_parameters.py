...
def test_declaration_with_deterministic():
    ...
    pvd = OSC.ParameterValueDistribution('my_parametrization','Mandolin','my_test.xosc',det)

    pvd2 = OSC.ParameterValueDistribution('my_parametrization','Mandolin','my_test.xosc',det)

    pvd3 = OSC.ParameterValueDistribution('my_parametrization','Mandolin','my_test2.xosc',det)
    stoc2 = OSC.Stochastic(100,1.234)
...
@pytest.mark.parametrize("distribution",[OSC.NormalDistribution(1,2),
...
@pytest.mark.parametrize("distribution",[OSC.DistributionRange(10,OSC.Range(0,10)),
                                        dist_set
                                    ])

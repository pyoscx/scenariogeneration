    ...
    def get_element(self):
        ...
        if self.object_type:
            for object_type in self.object_type:
                ET.SubElement(members,'ByType',attrib={'value':object_type.get_name()})
        return element
...
class Vehicle(VersionBase):
    ...
    """
    def __init__(self,name, vehicle_type, boundingbox, frontaxle, rearaxle, max_speed, max_acceleration, max_deceleration, mass=None, model3d=None):

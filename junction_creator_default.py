...
road2.add_predecessor(xodr.ElementType.junction, 100, direct_junction={})
road3.add_predecessor(xodr.ElementType.junction, 100, direct_junction={})

junction_creator.add_incomming_road_circular_junction(road1, radius = 20, angle=0)
junction_creator.add_incomming_road_circular_junction(road2, radius = 30, angle=1.3*np.pi)
junction_creator.add_incomming_road_circular_junction(road3, radius = 20, angle=0.7*np.pi/2)
...
junction = xodr.create_junction(junction_creator.get_connecting_roads(), 100, [road1, road2, road3])
print(junction_creator.get_connecting_roads())

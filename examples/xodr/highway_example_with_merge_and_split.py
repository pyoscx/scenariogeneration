...
roads= []
# start road
roads.append(xodr.create_road([xodr.Spiral(-0.004,0.00001,100), xodr.Spiral(0.00001,0.005,50), xodr.Arc(0.005,50)],id =0,left_lanes=2,right_lanes=[xodr.LaneDef(50,175,3,4,-4)]))
# intermittent road
roads.append(xodr.create_road([xodr.Spiral(0.0001,0.003,65), xodr.Spiral(0.003,0.00001,50) ],id =1,left_lanes=[xodr.LaneDef(10,100,2,3,3)],right_lanes=3))


#exit road
roads.append(xodr.create_road(xodr.Line(50),id =2,left_lanes=0,right_lanes=1))
# junctions for exit
roads.append(xodr.create_road(xodr.Spiral(0.005,0.0001,50),id =3,left_lanes=2,right_lanes=3,road_type=1)) # continue

...
road1 = xodr.create_road(xodr.Line(100),1,xodr.LaneDef(0,100,2,2,None,[3,1]),xodr.LaneDef(0,100,2,2,None,[4,1]))
road2 = xodr.create_road(xodr.Line(100),2,0,[xodr.LaneDef(0,100,2,2,None,[2,2])])
road3 = xodr.create_road(xodr.Line(100),3,[xodr.LaneDef(0,100,2,2,None,[4,4])],0)
road4 = xodr.create_road(xodr.Line(100),4,[xodr.LaneDef(0,100,2,2,None,[3,3])],[xodr.LaneDef(0,100,2,2,None,[4,4])])

# create the connection in the junction
jc = xodr.CommonJunctionCreator(100,'my junc')
jc.add_incoming_road_cartesian_geometry(road1,0,-20,-np.pi/2*3,'successor')
jc.add_incoming_road_cartesian_geometry(road4,5,30,-np.pi/2-0.1,'successor')

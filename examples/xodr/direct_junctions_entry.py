...
entry_road.add_predecessor(xodr.ElementType.junction,100,lane_offset=2,direct_junction=[1])

# create the direct junction struct
direct_junction = xodr.create_direct_junction([first_road,continuation_road,entry_road],100)

...
tar_action = xosc.AbsoluteSynchronizeAction(egoname,xosc.LanePosition(200,0,-1,0),xosc.LanePosition(200,0,-2,0),target_tolerance_master=1,target_tolerance=1, final_speed=xosc.FinalSpeed(xosc.AbsoluteSpeed(10)))

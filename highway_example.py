...
# intermittent road
roads.append(pyodrx.create_road([pyodrx.Line(30), ],id =1,left_lanes=3,right_lanes=3, polesLeft=True, guardrailLeft=True, guardrailRight=True))
...
jerseyBarrier0 = pyodrx.Object(0,0,height=0.75,zOffset=0,Type=pyodrx.ObjectType.barrier,name="jerseyBarrier")
jerseyBarrier0.repeat(200, 0)

jerseyBarrier1 = pyodrx.Object(0,0,height=0.75,zOffset=0,Type=pyodrx.ObjectType.barrier,name="jerseyBarrier")
jerseyBarrier1.repeat(30, 0)

jerseyBarrier3 = pyodrx.Object(0,0,height=0.75,zOffset=0,Type=pyodrx.ObjectType.barrier,name="jerseyBarrier")
jerseyBarrier3.repeat(50, 0)

jerseyBarrier5 = pyodrx.Object(0,0,height=0.75,zOffset=0,Type=pyodrx.ObjectType.barrier,name="jerseyBarrier")
jerseyBarrier5.repeat(105, 0)

jerseyBarrier6 = pyodrx.Object(0,0,height=0.75,zOffset=0,Type=pyodrx.ObjectType.barrier,name="jerseyBarrier")
jerseyBarrier6.repeat(30, 0)

speedLimitCenter0 = pyodrx.Signal(10,0,country="DEU",Type="274", subtype="120", zOffset=1.8)
speedLimitRight0 = pyodrx.Signal(10,-13,country="DEU",Type="274", subtype="120", zOffset=1.8)
speedLimitCenter5 = pyodrx.Signal(80,0,country="DEU",Type="274", subtype="120", zOffset=1.8, orientation=pyodrx.Orientation.negative)
speedLimitRight5 = pyodrx.Signal(80,7,country="DEU",Type="274", subtype="120", zOffset=1.8, orientation=pyodrx.Orientation.negative)

#create guardrails that cannot easily be autogenerated along entire road
guardrailGap3 = pyodrx.Object(40,-9.8,height=0.3,zOffset=0.4,Type=pyodrx.ObjectType.barrier,name="guardRail")
guardrailGap3.repeat(10, 0)  
guardrailGap4 = pyodrx.Object(41,0.85,height=0.3,zOffset=0.4,Type=pyodrx.ObjectType.barrier,name="guardRail",hdg=3.14)
guardrailGap4.repeat(59, 0)  
guardrailGap7 = pyodrx.Object(32,-0.8,height=0.3,zOffset=0.4,Type=pyodrx.ObjectType.barrier,name="guardRail")
guardrailGap7.repeat(18, 0)  
...
roads[3].add_object(guardrailGap3)
roads[4].add_object(guardrailGap4)
roads[7].add_object(guardrailGap7)

roads[0].add_signal([speedLimitCenter0, speedLimitRight0])
roads[5].add_signal([speedLimitCenter5, speedLimitRight5])
...
# write the road to an xodr file
